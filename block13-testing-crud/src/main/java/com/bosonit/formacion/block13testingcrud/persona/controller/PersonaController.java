...
import com.bosonit.formacion.block13testingcrud.persona.application.PersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<Object> getPersonasByName(@PathVariable("nombre") String nombre) {
        try {
