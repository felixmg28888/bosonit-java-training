...
import com.bosonit.formacion.block13testingcrud.exception.EmptyListExcepcion;
import com.bosonit.formacion.block13testingcrud.profesor.application.ProfesorService;
...
import com.bosonit.formacion.block13testingcrud.student.application.StudentService;
    ...
    public ResponseEntity<Object> getAllProfesores() {
        try {
            ...
            if (profesorOutputDtoList.isEmpty()) {
                throw new EmptyListExcepcion("Lista vacía.");
            }
