package com.bosonit.formacion.block070201crudvalidation.persona.controller;

import com.bosonit.formacion.block070201crudvalidation.persona.application.PersonaService;
...
public class PersonaController {
    ...
    @PostMapping
    public ResponseEntity<?> addPersona(@RequestBody PersonaInputDto personaInputDto) throws Exception {
        try {
